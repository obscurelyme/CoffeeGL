...
public:
  Triangle() {
    ...
    shaderProg = new CoffeeGL::ShaderProgram("assets/shaders/hello-tri-color.vert", "assets/shaders/hello-tri-color.frag");
  ...
  void Draw() {
    ...
    // std::cout << CoffeeMaker::DeltaTime::Value() << " " << greenValue << std::endl;
